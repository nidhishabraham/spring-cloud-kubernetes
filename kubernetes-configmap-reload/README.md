...
-------
    git clone https://github.com/nidhishabraham/spring-cloud-kubernetes.git
...
--------------
    docker build -t nidhishabraham/kubernetes-configmap-reload .
...
-----------
    docker push nidhishabraham/kubernetes-configmap-reload
